  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-axio-bg">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 font-sans">
        ...
        <section className="analytics-scroll-reveal action-reveal mb-12">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-2 px-5 py-3 bg-axio-red hover:bg-red-500 text-white rounded-lg font-bold text-[10px] shadow-[0_12px_35px_rgba(255,48,70,0.16)] hover:shadow-[0_15px_45px_rgba(255,48,70,0.25)] transition-all duration-300 hover:-translate-y-0.5"
            >
        ...
        <section
          className="analytics-scroll-reveal action-reveal mb-10"
        ...
        {activeTab === 'Analytics' && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div
                className="analytics-scroll-reveal action-reveal lg:col-span-7 group relative overflow-hidden rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-6"
              ...
              <div
                className="analytics-scroll-reveal action-reveal lg:col-span-5 group relative overflow-hidden rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-6"
            ...
            <div
              className="analytics-scroll-reveal action-reveal group relative overflow-hidden rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-6"
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                >
                  <span>TRANSFER FILTERS TO AXIS</span>
        ...
        {activeTab === 'PowerBI' && (
          <div
            className="analytics-scroll-reveal action-reveal relative overflow-hidden rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-6 sm:p-8"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              ...
              {permissions.canAccessPowerBiRefresh && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-axio-red hover:bg-red-500 text-white font-bold text-[10px] rounded-lg transition-all"
                >
                  <RefreshCw
        ...
        {activeTab === 'Reports' && (
          <div className="space-y-6">
            ...
            <div
              className="analytics-scroll-reveal action-reveal flex justify-end"
            >
              <button
                onClick={() => setIsModalOpen(true)}
                className="group flex items-center gap-2 px-5 py-2.5 bg-axio-red hover:bg-red-500 text-white font-bold text-[10px] rounded-lg shadow-[0_10px_30px_rgba(255,48,70,0.15)] transition-all hover:-translate-y-0.5"
              >
            ...
            <div className="analytics-scroll-reveal action-reveal overflow-x-auto rounded-2xl bg-axio-panel/55 backdrop-blur-xl">
                ...
                <tbody>
                  {reports.map((rep) => (
                    ...
                    >
                      ...
                      <td className="p-5">
                        <span
                          className={`px-2 py-1 rounded-full font-bold text-[9px] ${rep.format === 'PDF'
                      ...
                      <td className="p-5 text-right">
                        <button className="px-3 py-2 bg-axio-red/5 hover:bg-axio-red/10 rounded-lg text-xs text-white inline-flex items-center gap-1.5 transition-colors">
              ...
              <div className="space-y-5 text-xs">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-axio-bg/60 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-1 focus:ring-axio-red/40 transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-axio-bg/60 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-1 focus:ring-axio-red/40"
                  >
                    <option>
                      Root Cause Analysis
                    </option>
                ...
                <div className="flex justify-end gap-3 pt-5">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-white/[0.03] hover:bg-white/[0.06] rounded-lg text-axio-text-sub text-[10px] font-bold transition-colors"
                  >
                    CANCEL
                  </button>
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-axio-red hover:bg-red-500 disabled:opacity-50 text-white font-bold rounded-lg flex items-center gap-2 text-[10px] transition-all"
                  >
                    {isGenerating ? (
