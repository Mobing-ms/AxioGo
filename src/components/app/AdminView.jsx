...
export const AdminView = () => {
  ...
  useEffect(() => {
    const elements = document.querySelectorAll('.admin-scroll-reveal');
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-axio-bg">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        ...
        <section className="admin-scroll-reveal action-reveal mb-12">
        ...
        <section
          className="admin-scroll-reveal action-reveal mb-10"
        ...
        {activeAdminTab === 'Monitoring' && (
          <section className="admin-scroll-reveal action-reveal">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {systemHealth.map((sys, index) => {
                ...
                return (
                  <div
                    key={sys.name}
                    className="admin-scroll-reveal action-reveal group relative overflow-hidden rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-5 transition-all duration-500 hover:-translate-y-1"
                    style={{
        ...
        {activeAdminTab === 'User Management' && (
          <section className="admin-scroll-reveal action-reveal">
            ...
            <div className="overflow-x-auto rounded-2xl bg-axio-panel/55 backdrop-blur-xl">
        ...
        {activeAdminTab === 'Databricks Ops' && (
          <section
            className="admin-scroll-reveal action-reveal"
            style={{ transitionDelay: '100ms' }}
          >
            <div className="max-w-4xl rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-7 sm:p-8">
              ...
              <p className="text-sm text-axio-text-secondary font-sans leading-relaxed mb-6">
                AxioGo interfaces with Databricks REST API v2.1 for catalog
                syncing and job execution.
              </p>

              <div className="p-4 rounded-xl bg-axio-bg/60 font-mono text-xs">
                <span className="text-axio-muted">HOST:</span>{' '}
                ...
                <span className="text-axio-muted">TOKEN:</span>{' '}
          ...
          >
            <div className="max-w-4xl rounded-2xl bg-axio-panel/55 backdrop-blur-xl p-7 sm:p-8">
              ...
              <p className="text-sm text-axio-text-secondary font-sans leading-relaxed mb-7">
                Configure temperature, max tokens, and RAG chunk retrieval
                boundaries.
              </p>
              ...
              <div className="space-y-5 max-w-md">
                ...
                <button className="mt-2 px-5 py-2.5 bg-axio-red hover:bg-red-500 text-white text-[10px] font-bold rounded-lg flex items-center gap-2 shadow-[0_10px_30px_rgba(255,48,70,0.15)] transition-all hover:-translate-y-0.5">
